# Architecture drift report  (commit orchardcore-remove_dep-04)

## New code facts not represented in model
- _none_

## Model elements no longer found in code
- removed edge `csharp:csproj:src/OrchardCore/OrchardCore.Application.Cms.Core.Targets/OrchardCore.Application.Cms.Core.Targets.csproj` → `csharp:csproj:src/OrchardCore.Modules/OrchardCore.Cors/OrchardCore.Cors.csproj`
