# Architecture drift report  (commit nopcommerce-merge_targets-02)
...
- removed edge `csharp:csproj:src/Presentation/Nop.Web.Framework/Nop.Web.Framework.csproj` → `csharp:csproj:src/Libraries/Nop.Data/Nop.Data.csproj`
