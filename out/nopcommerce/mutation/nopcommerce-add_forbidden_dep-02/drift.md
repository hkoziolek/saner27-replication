# Architecture drift report  (commit nopcommerce-add_forbidden_dep-02)

## New code facts not represented in model
- new edge `csharp:csproj:src/Plugins/Nop.Plugin.Misc.Dynamics365/Nop.Plugin.Misc.Dynamics365.csproj` → `csharp:csproj:src/Plugins/Nop.Plugin.Misc.AzureBlob/Nop.Plugin.Misc.AzureBlob.csproj`
...
- ❌ `csharp:csproj:src/Plugins/Nop.Plugin.Misc.Dynamics365/Nop.Plugin.Misc.Dynamics365.csproj` -/-> `csharp:csproj:src/Plugins/Nop.Plugin.Misc.AzureBlob/Nop.Plugin.Misc.AzureBlob.csproj`: **VIOLATION** — `csharp:csproj:src/Plugins/Nop.Plugin.Misc.Dynamics365/Nop.Plugin.Misc.Dynamics365.csproj`→`csharp:csproj:src/Plugins/Nop.Plugin.Misc.AzureBlob/Nop.Plugin.Misc.AzureBlob.csproj`
