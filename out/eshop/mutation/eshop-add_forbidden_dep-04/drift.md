# Architecture drift report  (commit eshop-add_forbidden_dep-04)

## New code facts not represented in model
- new edge `csharp:csproj:src/WebApp/WebApp.csproj` → `csharp:csproj:src/Ordering.Infrastructure/Ordering.Infrastructure.csproj`
...
- ❌ `csharp:csproj:src/WebApp/WebApp.csproj` -/-> `csharp:csproj:src/Ordering.Infrastructure/Ordering.Infrastructure.csproj`: **VIOLATION** — `csharp:csproj:src/WebApp/WebApp.csproj`→`csharp:csproj:src/Ordering.Infrastructure/Ordering.Infrastructure.csproj`
