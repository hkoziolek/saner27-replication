# Architecture drift report  (commit nopcommerce-rename_target-02)

## New code facts not represented in model
- new target `csharp:csproj:src/Plugins/Nop.Plugin.Misc.CloudflareImages/Nop.Plugin.Misc.CloudflareImagesAnonMut.csproj`
- new edge `csharp:csproj:src/Plugins/Nop.Plugin.Misc.CloudflareImages/Nop.Plugin.Misc.CloudflareImagesAnonMut.csproj` → `csharp:csproj:src/Presentation/Nop.Web.Framework/Nop.Web.Framework.csproj`

## Model elements no longer found in code
- `csharp:csproj:src/Plugins/Nop.Plugin.Misc.CloudflareImages/Nop.Plugin.Misc.CloudflareImages.csproj`
- removed edge `csharp:csproj:src/Plugins/Nop.Plugin.Misc.CloudflareImages/Nop.Plugin.Misc.CloudflareImages.csproj` → `csharp:csproj:src/Presentation/Nop.Web.Framework/Nop.Web.Framework.csproj`

## Suspected renames / moves (§7.3 — pin via id_aliases)
- `csharp:csproj:src/Plugins/Nop.Plugin.Misc.CloudflareImages/Nop.Plugin.Misc.CloudflareImages.csproj` → `csharp:csproj:src/Plugins/Nop.Plugin.Misc.CloudflareImages/Nop.Plugin.Misc.CloudflareImagesAnonMut.csproj` (suspected rename/move)
