# Architecture drift report  (commit nopcommerce-add_forbidden_dep-01)

## New code facts not represented in model
- new edge `csharp:csproj:src/Libraries/Nop.Core/Nop.Core.csproj` → `csharp:csproj:src/Plugins/Nop.Plugin.DiscountRules.CustomerRoles/Nop.Plugin.DiscountRules.CustomerRoles.csproj`
...
- ❌ `csharp:csproj:src/Libraries/Nop.Core/Nop.Core.csproj` -/-> `csharp:csproj:src/Plugins/Nop.Plugin.DiscountRules.CustomerRoles/Nop.Plugin.DiscountRules.CustomerRoles.csproj`: **VIOLATION** — `csharp:csproj:src/Libraries/Nop.Core/Nop.Core.csproj`→`csharp:csproj:src/Plugins/Nop.Plugin.DiscountRules.CustomerRoles/Nop.Plugin.DiscountRules.CustomerRoles.csproj`
