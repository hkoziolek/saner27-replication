# Architecture drift report  (commit nopcommerce-add_forbidden_dep-04)

## New code facts not represented in model
- new edge `csharp:csproj:src/Plugins/Nop.Plugin.Shipping.UPS/Nop.Plugin.Shipping.UPS.csproj` → `csharp:csproj:src/Libraries/Nop.Core/Nop.Core.csproj`
...
- ❌ `csharp:csproj:src/Plugins/Nop.Plugin.Shipping.UPS/Nop.Plugin.Shipping.UPS.csproj` -/-> `csharp:csproj:src/Libraries/Nop.Core/Nop.Core.csproj`: **VIOLATION** — `csharp:csproj:src/Plugins/Nop.Plugin.Shipping.UPS/Nop.Plugin.Shipping.UPS.csproj`→`csharp:csproj:src/Libraries/Nop.Core/Nop.Core.csproj`
