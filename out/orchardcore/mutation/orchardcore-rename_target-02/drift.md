# Architecture drift report  (commit orchardcore-rename_target-02)

## New code facts not represented in model
- new target `csharp:csproj:src/OrchardCore.Modules/OrchardCore.Media.Indexing.OpenXML/OrchardCore.Media.Indexing.OpenXMLAnonMut.csproj`
- new edge `csharp:csproj:src/OrchardCore.Modules/OrchardCore.Media.Indexing.OpenXML/OrchardCore.Media.Indexing.OpenXMLAnonMut.csproj` → `csharp:csproj:src/OrchardCore/OrchardCore.Indexing.Abstractions/OrchardCore.Indexing.Abstractions.csproj`
- new edge `csharp:csproj:src/OrchardCore.Modules/OrchardCore.Media.Indexing.OpenXML/OrchardCore.Media.Indexing.OpenXMLAnonMut.csproj` → `csharp:csproj:src/OrchardCore/OrchardCore.Media.Abstractions/OrchardCore.Media.Abstractions.csproj`
- new edge `csharp:csproj:src/OrchardCore.Modules/OrchardCore.Media.Indexing.OpenXML/OrchardCore.Media.Indexing.OpenXMLAnonMut.csproj` → `csharp:csproj:src/OrchardCore/OrchardCore.Module.Targets/OrchardCore.Module.Targets.csproj`
- new edge `csharp:csproj:src/OrchardCore.Modules/OrchardCore.Media.Indexing.OpenXML/OrchardCore.Media.Indexing.OpenXMLAnonMut.csproj` → `csharp:csproj:src/OrchardCore/OrchardCore.ResourceManagement/OrchardCore.ResourceManagement.csproj`
- new edge `csharp:csproj:src/OrchardCore/OrchardCore.Application.Cms.Core.Targets/OrchardCore.Application.Cms.Core.Targets.csproj` → `csharp:csproj:src/OrchardCore.Modules/OrchardCore.Media.Indexing.OpenXML/OrchardCore.Media.Indexing.OpenXMLAnonMut.csproj`
...
- `csharp:csproj:src/OrchardCore.Modules/OrchardCore.Media.Indexing.OpenXML/OrchardCore.Media.Indexing.OpenXML.csproj` → `csharp:csproj:src/OrchardCore.Modules/OrchardCore.Media.Indexing.OpenXML/OrchardCore.Media.Indexing.OpenXMLAnonMut.csproj` (suspected rename/move)
