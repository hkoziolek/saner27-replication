# Architecture drift report  (commit nopcommerce-rename_target-01)

## New code facts not represented in model
- new target `csharp:csproj:src/Libraries/Nop.Core/Nop.CoreAnonMut.csproj`
- new edge `csharp:csproj:src/Libraries/Nop.Data/Nop.Data.csproj` → `csharp:csproj:src/Libraries/Nop.Core/Nop.CoreAnonMut.csproj`
- new edge `csharp:csproj:src/Libraries/Nop.Services/Nop.Services.csproj` → `csharp:csproj:src/Libraries/Nop.Core/Nop.CoreAnonMut.csproj`
- new edge `csharp:csproj:src/Presentation/Nop.Web.Framework/Nop.Web.Framework.csproj` → `csharp:csproj:src/Libraries/Nop.Core/Nop.CoreAnonMut.csproj`
- new edge `csharp:csproj:src/Presentation/Nop.Web/Nop.Web.csproj` → `csharp:csproj:src/Libraries/Nop.Core/Nop.CoreAnonMut.csproj`
...
- `csharp:csproj:src/Libraries/Nop.Core/Nop.Core.csproj` → `csharp:csproj:src/Libraries/Nop.Core/Nop.CoreAnonMut.csproj` (suspected rename/move)
