# Architecture drift report  (commit nopcommerce-remove_target-04)
...
- ❌ `Shipping & Tax Plugins` -/-> `Web Application`: **VIOLATION** — `csharp:csproj:src/Plugins/Nop.Plugin.Tax.Avalara/Nop.Plugin.Tax.Avalara.csproj`→`csharp:csproj:src/Presentation/Nop.Web/Nop.Web.csproj`, `csharp:csproj:src/Plugins/Nop.Plugin.Tax.FixedOrByCountryStateZip/Nop.Plugin.Tax.FixedOrByCountryStateZip.csproj`→`csharp:csproj:src/Presentation/Nop.Web/Nop.Web.csproj`
