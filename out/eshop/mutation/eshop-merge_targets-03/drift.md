# Architecture drift report  (commit eshop-merge_targets-03)

## New code facts not represented in model
- new edge `csharp:csproj:src/Ordering.Infrastructure/Ordering.Infrastructure.csproj` → `csharp:csproj:src/eShop.ServiceDefaults/eShop.ServiceDefaults.csproj`
