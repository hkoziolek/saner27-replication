# Architecture drift report  (commit eshop-merge_targets-04)

## New code facts not represented in model
- new edge `csharp:csproj:src/HybridApp/HybridApp.csproj` → `csharp:csproj:src/eShop.ServiceDefaults/eShop.ServiceDefaults.csproj`
