# Architecture drift report  (commit nopcommerce-merge_targets-03)
...
- removed edge `csharp:csproj:src/Libraries/Nop.Services/Nop.Services.csproj` → `csharp:csproj:src/Libraries/Nop.Data/Nop.Data.csproj`
- removed edge `csharp:csproj:src/Presentation/Nop.Web.Framework/Nop.Web.Framework.csproj` → `csharp:csproj:src/Libraries/Nop.Services/Nop.Services.csproj`
- removed edge `csharp:csproj:src/Presentation/Nop.Web/Nop.Web.csproj` → `csharp:csproj:src/Libraries/Nop.Services/Nop.Services.csproj`
