# Architecture drift report  (commit eshop-remove_dep-02)

## New code facts not represented in model
- _none_

## Model elements no longer found in code
- removed edge `csharp:csproj:src/OrderProcessor/OrderProcessor.csproj` → `csharp:csproj:src/EventBusRabbitMQ/EventBusRabbitMQ.csproj`
