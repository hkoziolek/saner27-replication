# Architecture drift report  (commit nopcommerce-rename_target-03)

## New code facts not represented in model
- new target `csharp:csproj:src/Plugins/Nop.Plugin.Misc.RFQ/Nop.Plugin.Misc.RFQAnonMut.csproj`
- new edge `csharp:csproj:src/Plugins/Nop.Plugin.Misc.RFQ/Nop.Plugin.Misc.RFQAnonMut.csproj` → `csharp:csproj:src/Presentation/Nop.Web/Nop.Web.csproj`
...
- `csharp:csproj:src/Plugins/Nop.Plugin.Misc.RFQ/Nop.Plugin.Misc.RFQ.csproj` → `csharp:csproj:src/Plugins/Nop.Plugin.Misc.RFQ/Nop.Plugin.Misc.RFQAnonMut.csproj` (suspected rename/move)
