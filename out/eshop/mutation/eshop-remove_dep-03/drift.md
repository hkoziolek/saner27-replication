# Architecture drift report  (commit eshop-remove_dep-03)

## New code facts not represented in model
- _none_

## Model elements no longer found in code
- removed edge `csharp:csproj:src/PaymentProcessor/PaymentProcessor.csproj` → `csharp:csproj:src/EventBusRabbitMQ/EventBusRabbitMQ.csproj`
